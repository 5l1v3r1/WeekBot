return {
	...
	["Sat"] = {
		...
		facts = {
			[1] = "Saturday is my developer's most desired day.",
			...
			[4] = "Nuclear power plants are one of the safest ways to generate energy, producing 100 times less radiation than coal plants. And they're 100% emission free.",
			[5] = "Chuck Norris was a character in all six star wars movies. He was the force.",
